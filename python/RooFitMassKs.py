...
class RooFitMassKs(AlgorithmBase):
    def __init__(self):
        print "initialization RooFitMassKs "
        self.histograms= { }
        self.result=''
    ...
    def Fill(self, tree):
        print "Begin fill RooFitMassKs with"
        branchName="MM"
        ...
        print "End of fill RooFitMassKs"


    def ProcessData(self):
        # this is a little bit silly but without default initialization of RooFit object the program doesnt work
        x= RooRealVar("x","mass Ks",0.46,0.53,"GeV")
        mean1= RooRealVar("mean1","mean1",0.497,0,10)
        mean2= RooRealVar("mean2","mean2",0.51,0,10)
        ...
        # create output
        xframe=x.frame(RooFit.Title("Mass Fit Ks"))
    ...
    def SaveOutput(self):
        gDirectory.mkdir("RooFitMassKs")
        gDirectory.cd("RooFitMassKs")
